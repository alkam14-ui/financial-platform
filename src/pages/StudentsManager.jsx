...
import StudentListsView from '../components/students/StudentListsView.jsx';
    ...
    <div className="manager-container" style={{ backgroundColor: '#ffffff', padding: '32px', borderRadius: '24px', border: '2px solid #bae6fd', fontFamily: 'Cairo, sans-serif' }}>
      ...
      {!loading && activeTab === 'manager' && (
        <StudentListsView
          ...
          selectedListStudents={selectedListStudents}
          editingList={editingList}
          editingDrafts={editingDrafts}
          onSelectList={(listId) => { setSelectedListId(listId); setEditingList(false); }}
          onDeleteList={handleDeleteList}
          onPrint={() => window.print()}
          onStartEdit={handleStartListEdit}
          onSaveEdits={handleSaveListEdits}
          onCancelEdits={handleCancelListEdits}
          onDraftChange={handleDraftStudentChange}
        />
      )}
