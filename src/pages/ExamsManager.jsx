...
import ExamPaperView from '../components/exams/ExamPaperView.jsx';
  ...
  return (
    <div style={{ fontFamily: 'Cairo, sans-serif', direction: 'rtl' }} id="printable-exam-sheet-container">
      ...
      {showGeneratedExamPaper && displayedExam && (
        <ExamPaperView
          displayedExam={displayedExam}
          editingExam={editingExam}
          examTypeNames={examTypeNames}
          gradeNamesMap={gradeNamesMap}
          directorateName={directorateName}
          schoolName={schoolName}
          teacherName={teacherName}
          currentExamDocId={currentExamDocId}
          savingExam={savingExam}
          onPrint={() => window.print()}
          onSaveModel={handleSaveExamModel}
          onStartEdit={handleStartExamEdit}
          onSaveEdits={handleSaveExamEdits}
          onCancelEdit={handleCancelExamEdit}
          onRebuild={handleRebuildAllExecution}
          onDraftPromptChange={handleDraftPromptChange}
          onDraftOptionChange={handleDraftOptionChange}
        />
      )}
    </div>
  );
